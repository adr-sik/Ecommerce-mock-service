        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsFastCharging = table.Column<bool>(type: "bit", nullable: false),
                    Port = table.Column<string>(type: "nvarchar(max)", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ChargingAccessory", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    HeadphoneType = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    BatteryLife = table.Column<int>(type: "int", nullable: true),
                    ChargingAccessoryId = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Products_ChargingAccessory_ChargingAccessoryId",
                        column: x => x.ChargingAccessoryId,
                        principalTable: "ChargingAccessory",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Products_Cpus_CpuId",
                        column: x => x.CpuId,
                        principalTable: "Cpus",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Products_ChargingAccessoryId",
                table: "Products",
                column: "ChargingAccessoryId");

            migrationBuilder.CreateIndex(
                name: "IX_Products_CpuId",
                table: "Products",
                column: "CpuId");
